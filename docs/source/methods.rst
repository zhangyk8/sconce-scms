...
Despite its fast convergence and wide applications in identifying density ridges, the standard SCMS algorithm fails to take into account any non-linear curvature in the data space; see examples in [1]_ and [4]_. 
...
.. [2] C. R. Genovese, M. Perone-Pacifico, I. Verdinelli, and L. Wasserman (2014). Nonparametric ridge estimation. The Annals of Statistics, **42**(4), 1511-1545.
